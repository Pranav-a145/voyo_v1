  ...
  return (
    <div className={`bg-white rounded-2xl overflow-hidden flex flex-col transition-all duration-200 shadow-sm hover:shadow-xl hover:-translate-y-0.5 ${
      ...
      <div className="p-5 flex flex-col gap-2.5 flex-1">
        ...
        <button
          onClick={onPlanNow}
          className="mt-0.5 w-full py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 active:from-blue-800 active:to-indigo-800 text-white text-sm font-semibold rounded-xl transition-all shadow-sm hover:shadow-md"
        >
          Plan Now →
        </button>
      </div>
